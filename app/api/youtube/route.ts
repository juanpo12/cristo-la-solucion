...
const CHANNEL_ID = env.PASTOR_CHANNEL_ID // Usamos el canal del pastor que está configurado en .env.local
...
async function getChannelVideos() {
  ...
  try {
    ...
    // Combinar datos
    const videos = videosData.items.map((item: { id: { videoId: string }, snippet: any }) => {
